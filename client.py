...
def client_gui():
    ...
    connect_button = tk.Button(
        ...
        command=lambda: connect_to_server(username_entry.get(), text_area)  # Call connect function
    )
